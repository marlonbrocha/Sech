...
exports.default = {
    ...
    methods: {
        addCid: function addCid() {
            this.paciente.cids.push({
                idcid10: this.idcid10
            });

            $.notify("Diagnóstico adicionado", { globalPosition: "top center",
                className: 'success' });
        },
        removeCid: function removeCid(cid) {
            var index = this.paciente.cids.indexOf(cid);
            if (index > -1) {
                this.paciente.cids.splice(index, 1);
            }
        },
        clinica: function clinica(_clinica) {
            this.leitos = [];
            var i;
            for (i = 0; i < this.leito_all.length; i++) {
                if (this.leito_all[i].idclinica == _clinica) {
        ...
        adicionar: function adicionar() {
            ...
            if (this.paciente.cids == '') {
                ...
                this.$http.post('/internacao/create', this.paciente).then(function (response) {
...
exports.default = {
    ...
    methods: {
        ...
        abreEditSub: function abreEditSub(sub) {
...
},{"vue":25,"vue-hot-reload-api":22}],31:[function(require,module,exports){
'use strict';
        ...
        addMed: function addMed() {
            ...
            if (med == '') {
                ...
                if (classific != 9) {
                    ...
                    $.notify("Campo adicionado", { globalPosition: "top center",
                        className: 'success' });
                }
        ...
        this.$http.get('/prescricao/buscar/medicamentos/' + this.idprescricao).then(function (response) {
            ...
            for (i = 0; i < med_array.length; i++) {
                ...
                if (med_array[i]['outros'] != '') {
                    _this2.prescricao.prescricaomedicamento.push({
...
},{"babel-runtime/helpers/defineProperty":2,"vue":25,"vue-hot-reload-api":22}],33:[function(require,module,exports){
'use strict';
...
var _internacao = require('./components/internacao.vue');

var _internacao2 = _interopRequireDefault(_internacao);
...
var app = new _vue2.default({
    ...
    components: {
        ...
        VcInternacao: _internacao2.default
    }

});

},{"./components/clinica.vue":26,"./components/clinicaedit.vue":27,"./components/internacao.vue":28,"./components/medicamento.vue":29,"./components/medicamentoedit.vue":30,"./components/prescricao.vue":31,"./components/prescricaoedit.vue":32,"vue-resource/dist/vue-resource":23,"vue/dist/vue":24}]},{},[33]);
