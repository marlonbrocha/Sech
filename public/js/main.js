    ...
    methods: {
        ...
        buscarprontuario: function buscarprontuario() {
            ...
            this.$http.post('../buscapaciente', { prontuario: prontuario }).then(function (response) {
                ...
                var i;
                for (i = 0; i < _this2.cid_all.length; i++) {
                    if (_this2.cid_all[i].id = idinter) {
                        _this2.cids.push(_this2.cid_all[i].descricao);
                    }
                }

                console.log(_this2.cids);
            }).catch(function (response) {
        ...
        this.$http.get('/prescricao/buscar/medicamentos/' + this.idprescricao).then(function (response) {
            ...
            for (i = 0; i < med_array.length; i++) {
                ...
                if (med_array[i]['outros'] != '') {
                    _this3.prescricao.prescricaomedicamento.push({
                ...
                _this3.prescricao.relatorioAntimicro.push({
                    idmedicamento: '',
                    medInfe: '',
                    quantidade: '',
                    duracao: '',
