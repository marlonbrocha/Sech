    ...
    methods: {
        ...
        buscarprontuario: function buscarprontuario() {
            ...
            this.$http.post('../buscapaciente', { prontuario: prontuario }).then(function (response) {
                ...
                $("#buscar").modal('hide');
                _this3.nome = response.data[0].value;
                _this3.clinica = response.data[0].clinica;
