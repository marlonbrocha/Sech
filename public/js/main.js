    ...
    data: function data() {
        ...
        return {
            ...
            prescricao: (_prescricao = {
                ...
                historicoatual: '',
                evolucao: ''
            }, (0, _defineProperty3.default)(_prescricao, 'dataprescricao', ''), (0, _defineProperty3.default)(_prescricao, 'observacoesmedicas', ''), (0, _defineProperty3.default)(_prescricao, 'prescricaomedicamento', []), (0, _defineProperty3.default)(_prescricao, 'relatorioAntimicro', []), (0, _defineProperty3.default)(_prescricao, 'medicamentos_all', []), _prescricao)
        };
    },
    mounted: function mounted() {
...
exports.default = {
    ...
    methods: {
        ...
        salveRelatorio: function salveRelatorio() {
        ...
        adicionar: function adicionar() {
            ...
            this.$http.post('/prescricao/create', this.prescricao).then(function (response) {
                if (response.status == 202) {
                    _this2.verifica_relatorio = true;
                    var i;
        ...
        buscarprontuario: function buscarprontuario() {
            ...
            this.$http.post('../buscapaciente', { prontuario: prontuario }).then(function (response) {
                ...
                $("#buscar").modal('hide');
                _this4.paciente = response.data[0].nomecompleto;
                _this4.clinica = response.data[0].nome;
                _this4.numeroprontuario = response.data[0].numeroprontuario;
                _this4.leito = response.data[0].leito;
                _this4.diag = response.data[0].descricao;
                _this4.admissao = response.data[0].dataadmissao;
                _this4.prescricao.idinternacao = response.data[0].id;
            }).catch(function (response) {
                console.log(response);
                $("#buscar").modal('hide');
                swal({
        ...
        this.$http.get('/prescricao/buscar/medicamentos/' + this.idprescricao).then(function (response) {
            ...
            for (i = 0; i < med_array.length; i++) {
                ...
                if (med_array[i]['outros'] != '') {
                    _this5.prescricao.prescricaomedicamento.push({
                ...
                _this5.prescricao.relatorioAntimicro.push({
                    idmedicamento: '',
                    medInfe: '',
                    quantidade: '',
                    duracao: '',
